...
Config.PIANO = !1, Config.VERSION = "0.99", Config.WIDTH = 640, Config.HEIGHT = 712, Config.FONT_LEVEL_SELECT_ID = "Arial", Config.FONT_GAMEPLAY_LEVEL_ID = "Titan One", Config.TOUCH_BOUNDS = {
    x: 0,
    y: 100,
    width: Config.WIDTH,
...
App.GameplayState.prototype = {
    create: function () {
        ...
        }), this.shareBt = new App.MyButton(this.game, "creditsButton", this.shareClick, this, {
            x: 79,
            y:  100,
            center: !0,
            parentGroup: this.uiGroup,
